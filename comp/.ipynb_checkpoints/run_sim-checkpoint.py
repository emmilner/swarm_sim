...
new_beh = 0 
swarm_size = 50 # number of agents in the swarm 
...
if new_beh == 0:
	if task == 1:
		if bias == 0:
			#print("new ideas version")
			#for i in range(10):
			#	sim = sim_task_1_newideas.data(swarm_size,num_items,ani,time_limit)
			#print("original")
			for i in range(10):
	...
	if task == 2:
		if bias == 0:
			print("newideas")
			sim = sim_task_2_newideas.data(swarm_size,num_items,ani,time_limit)
